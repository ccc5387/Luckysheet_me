...
import {collaborativeEditBox, selectHightlightShow, selectIsOverlap} from '../controllers/select';
...
export function setRangeConditionalFormatDefault(conditionName, conditionValue, options = {}) {
    ...
    if(conditionName == 'betweenness'){
        ...
        let v = conditionValue[0];
console.log(' conditionValue[0]:',v,' conditionValue:',conditionValue)
        // if(v != 0 || v != 1){
        //     return tooltip.info('The conditionValue parameter is invalid!', '');
        // }
...
//计算公式链 所有表 jxh start
export function updateCalcChain() {
    const calcChain =  createCalcChainFromSheetData();
...
/**
 * 获取当前活动 的 index window.luckysheet.getCurrentIndex()
 */
