...
export const toolbarIdMap = {
    keep: '#luckysheet-icon-keep', // jxh start 保存
    ...
    upload: '#luckysheet-icon-upload' // jxh start 导入
};
...
export function createToolbarHtml() {
    ...
    const htmlMap = {
        //jxh start 添加保存 功能
        keep: `<div class="luckysheet-toolbar-button luckysheet-inline-block disabled" data-tips="保存"
        id="luckysheet-icon-keep" role="button" style="user-select: none;">
             保存
        </div>`,
  ...
  //  showtoolbarConfig.push('keep');
    console.log('showtoolbarConfig:',showtoolbarConfig)
